<template>
  <div v-if="visible" class="modal-overlay">
    <!--Formulario para la editar una factura existente-->
    <div class="form-invoice-container">
      ...
      <div class="buttons-container">
        <div class="button-save" @click="saveData">Guardar Cambios</div>
...
<script>
import { UseFormInvoiceMod } from "./scripts/formInvoiceModScript";
export default {
  ...UseFormInvoiceMod(),
};
</script>
